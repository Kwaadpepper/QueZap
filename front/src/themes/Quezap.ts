      ...
      colorScheme: {
        light: {
          root: {
            ...
            warn: {
              background: '{amber.700}',
              hoverBackground: '{amber.800}',
              activeBackground: '{amber.900}',
              borderColor: '{amber.700}',
              hoverBorderColor: '{amber.800}',
              activeBorderColor: '{amber.900}',
              color: '#ffffff',
              hoverColor: '#ffffff',
              activeColor: '#ffffff',
              focusRing: {
        ...
        dark: {
          ...
          outlined: {
            ...
            success: {
              hoverBackground: 'color-mix(in srgb, {green.600}, transparent 96%)',
              activeBackground: 'color-mix(in srgb, {green.600}, transparent 84%)',
              borderColor: '{green.700}',
              color: '{green.200}',
            },
            info: {
              hoverBackground: 'color-mix(in srgb, {teal.600}, transparent 96%)',
              activeBackground: 'color-mix(in srgb, {teal.600}, transparent 84%)',
              borderColor: '{teal.700}',
              color: '{teal.200}',
            },
            warn: {
              hoverBackground: 'color-mix(in srgb, {amber.600}, transparent 96%)',
              activeBackground: 'color-mix(in srgb, {amber.600}, transparent 84%)',
              borderColor: '{amber.700}',
              color: '{amber.200}',
            },
            help: {
            ...
            danger: {
              hoverBackground: 'color-mix(in srgb, {red.600}, transparent 96%)',
              activeBackground: 'color-mix(in srgb, {red.600}, transparent 84%)',
              borderColor: '{red.700}',
              color: '{red.200}',
            },
            contrast: {
      ...
      colorScheme: {
        ...
        dark: {
          info: {
            ...
            borderColor: 'color-mix(in srgb, {teal.700}, transparent 64%)',
            color: '{teal.200}',
            shadow: '0px 4px 8px 0px color-mix(in srgb, {teal.500}, transparent 96%)',
          },
          success: {
