...
export const SessionPageStore = signalStore(
  ...
  withMethods((store, sessionService = inject(SESSION_SERVICE)) => {
    ...
    const loadSessionPage = rxMethod<Pagination>(
      pipe(
        ...
        switchMap((pagination) => {
          ...
          return sessionService.getSessionPage(pagination).pipe(
    ...
    loadSessionPage(toObservable(store.query))
