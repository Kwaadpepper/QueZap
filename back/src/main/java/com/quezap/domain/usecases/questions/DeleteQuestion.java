...
public sealed interface DeleteQuestion {
  ...
  public static final class Handler implements UseCaseHandler<Input, Output>, DeleteQuestion {
    ...
    @Override
    public DeleteQuestion.Output handle(Input input) {
      ...
      return new DeleteQuestion.Output.QuestionDeleted();
    }
  }
}
